...
export default function Envelope({ onLetterClose }) {
  ...
  const text = "Энэ захиа очих өдрийн мэндийг хүргэе. Чинийхээ энэ онцгой өдөр, энэ жижигхэн вэбсайтыг зөвхөн чамдаа зориулан сэтгэл зүрхээ шингээж хийж бэлтгэлээ. Чамд минь таалагдана гэж найдаж байна. Төрсөн өдрийн гал халуун баярын мэндийг хүргэе! ❤️";
