...
export default function MouseEffects({
    ...
    interactionMode = "burst", // Burst looks good for birthday theme
    duration = 0.8,
    strokeWidth = 2,
    effectSize = 90,
    rotation = 0,
    ...
    useEffect(() => {
        ...
        // Use mousedown instead of click to feel more responsive, 
        // and attach to window to catch everything over absolute positioned elements
