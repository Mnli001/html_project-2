...
const letters = [
  {
    ...
    content: "Хэрэв чи намайг санаж байгаа бол... Би яг энэ мөчид бас чамайг л бодож байгаа. Чиний инээмсэглэл, хоолойны өнгө, над руу харж байгаа тэр харц үргэлж сэтгэлд тодхон байдаг. Хэзээд миний зүрх сэтгэл чамтай хамт шүү. Над руу хүссэн цагтаа залгаарай ❤️"
  },
  {
    id: 'sad',
    ...
    content: "Амьдралд хэцүү, бүх зүйл нэг л болж өгөхгүй өдрүүд байдаг. Гэхдээ битгий мартаарай: Чи бол үнэхээр хүчтэй, гайхалтай охин. Чиний хажууд чамайг ямар ч үед ойлгож, дэмжих би байгаа. Гүнзгий амьсгаа аваад тайвшир даа, бүх зүйл удахгүй сайхан болно ✨"
  },
  {
    id: 'smile',
    ...
    content: "Чиний инээмсэглэл бол энэ ертөнцийн хамгийн дулаахан, хамгийн үзэсгэлэнтэй зүйл. Чи инээхээрээ ямар хөөрхөн харагддаг гээч? Дэлхийг бүхэлд нь гэрэлтүүлж байгаа юм шиг л санагддаг. Үргэлж ингэж цоглог, гэгээлэг байгаарай 😊💖"
  },
  {
    id: 'mad',
    ...
    content: "Хэрэв би чамайг гомдоосон эсвэл уурлуулсан бол намайг уучлаарай. Би хэзээ ч чамайг гомдоохыг хүсээгүй. Чи миний хувьд хэчнээн нандин, үнэ цэнтэй хүн гэдгийг үргэлж санаж яваарай. Надад хэлмээр байгаа бүхнээ хэлж болно оо, би чамайг үргэлж сонсоход бэлэн 🥺❤️"
  }
];
